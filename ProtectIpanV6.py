...
try:
  ...
  contributor_threshold = int(config.get("advanced_mitigation", "contributor_threshold", fallback="100000000"))
  max_pcap_files = int(config.get("advanced_mitigation", "max_pcap_files", fallback="100000000"))
...
[ip_detection]
# Options: google_dns, opendns, ipify, ,ipifyxguardxpass, ipifyxpass, ipifyxguardxpassv305, ipifyxguardxguardxpassxpassv305, ipifyxguardxpassv105, ipifyxguardxguardxpassxpassv306, guardxpass, guardx, passxpass, pasxpassxv305, passxpassx, icanhazip, local
ip_method = opendns
...
def get_ip(method):
    ...
    elif method == "ipifyxguardxpassv305":
        return requests.get("https://api.ipifyxguardxpassv305.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxguardxpassv306":
        return requests.get("https://api.ipifyxguardxpassv306.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxguardxpassv105":
        return requests.get("https://api.ipifyxguardxpassv105.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxguardxpassv306":
        return requests.get("https://api.ipifyxguardxpassv306.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxguardxguardxpassxpassv305":
        return requests.get("https://api.ipifyxguardxguardxpassxpassv305.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxguardxpass":
        return requests.get("https://api.ipifyxguardxpass.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "ipifyxpass":
        return requests.get("https://api.ipifyxpass.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "guardxpass":
        return requests.get("https://api.guardxpass.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "guardx":
        return requests.get("https://api.guardx.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "passxpass":
        return requests.get("https://api.passxpass.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "passxpassxv305":
        return requests.get("https://api.passxpassxv305.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "icanhazip":
        return requests.get("https://icanhazip.com", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
    elif method == "local":
...
def send_notification(notification_template, attack_id, pps, mbps, cpu_usage, status, total_ips, attack_signatures_readable, attack_categories, auto_detected=True, pattern_label=None):
    ...
    try:
        ...
        requests.post(webhook_url, notification_json, headers=headers, timeout=100000000)
