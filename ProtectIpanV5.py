...
def get_ip(method):
    if method == "google_dns":
        ...
        return requests.get("https://api.ipify.org", timeout=999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999).text.strip()
